...
namespace PlayerSystem
{
	...
	internal class PlayerUltimateState : PlayerStateBase
	{
		...
		private readonly int _ultimateAnimatorHash = Animator.StringToHash("ultimate"); // 애니메이터의 매개변수 해시 (Bool)
		...
		// [생성자] 변수를 초기화합니다.
		internal PlayerUltimateState(PlayerControllerBase controller) : base(controller)
		{
		...
		{
			_animator.SetTrigger(_ultimateAnimatorHash);
		}

		// [함수] 애니메이션을 정지합니다.
		private void StopAnimation()
		{
			_animator.ResetTrigger(_ultimateAnimatorHash);
		}
